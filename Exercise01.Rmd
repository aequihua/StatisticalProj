...
# Simulations
Let $X$ be a random exponential variable with $\lambda = 0.2$. We are going to run 1000 random samples of size $n=40$. The following code produces the set of 1000 sample means and puts it into the dataframe **Xbardat**:
